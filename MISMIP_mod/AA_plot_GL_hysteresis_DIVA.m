...
foldernames = {...
  'MISMIP_mod_DIVA_64km',...
  'MISMIP_mod_DIVA_40km',...
  'MISMIP_mod_DIVA_32km',...
  'MISMIP_mod_DIVA_20km',...
  'MISMIP_mod_DIVA_16km',...
...
% end
% 
% save('tempdata_DIVA.mat','results');
load('tempdata_DIVA.mat');
