...
#include <petsc/finclude/petscksp.h>
  ...
  interface split_segment
    procedure :: split_segment
    procedure :: split_segment_new
  end interface
  interface flip_triangle_pairs
    procedure :: flip_triangle_pairs
    procedure :: flip_triangle_pairs_new
  end interface
  interface need_flipping
    procedure :: need_flipping
    procedure :: need_flipping_new
  end interface
  interface split_triangle
    procedure :: split_triangle
    procedure :: split_triangle_new
  end interface
  interface split_line
    procedure :: split_line
    procedure :: split_line_new
  end interface
  interface move_vertex
    procedure :: move_vertex
    procedure :: move_vertex_new
  end interface
  CONTAINS
  
  SUBROUTINE split_triangle_new( mesh, ti, p_new)
  ...
  END SUBROUTINE split_triangle_new
  ...
  SUBROUTINE split_line_new(     mesh, v1a, v2a, p_new)
  ...
  SUBROUTINE split_segment_new(  mesh, v1a, v2a, p_new)
  ...
  END SUBROUTINE split_segment_new
  ...
  SUBROUTINE flip_triangle_pairs_new( mesh, nf, did_flip)
  ...
  END SUBROUTINE flip_triangle_pairs_new
  ...
  SUBROUTINE need_flipping_new( mesh, t1, t2, isso, vo1, vo2, v1, v2, t1nv1, t1nv2, t2nv1, t2nv2)
...
!        norm2(mesh%V(vo1,:) - mesh%Tricc(t2,:)) < norm2(mesh%V(mesh%Tri(t2,1),:) - mesh%Tricc(t2,:)) - mesh%tol_dist) THEN
  ...
  END SUBROUTINE need_flipping_new
...
!        norm2(mesh%V(vo1,:) - mesh%Tricc(t2,:)) < norm2(mesh%V(mesh%Tri(t2,1),:) - mesh%Tricc(t2,:)) - mesh%tol_dist) THEN
  ...
  SUBROUTINE move_vertex_new( mesh, vi, p)
  ...
  END SUBROUTINE move_vertex_new
