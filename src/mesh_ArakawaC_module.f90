...
#include <petsc/finclude/petscksp.h>
  ...
  IMPLICIT NONE
  interface make_Ac_mesh
    procedure :: make_Ac_mesh
    procedure :: make_Ac_mesh_new
  end interface
  interface find_Ac_edge_indices
    procedure :: find_Ac_edge_indices
    procedure :: find_Ac_edge_indices_new
  end interface

  CONTAINS
    
  SUBROUTINE make_Ac_mesh_new( mesh)
  ...
  END SUBROUTINE make_Ac_mesh_new
  ...
  SUBROUTINE find_Ac_edge_indices_new( mesh)
  ...
  END SUBROUTINE find_Ac_edge_indices_new
