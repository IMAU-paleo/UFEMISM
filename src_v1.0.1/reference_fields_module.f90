MODULE reference_fields_module
  ...
  USE data_types_module,           ONLY: type_mesh, type_init_data_fields, type_PD_data_fields, type_netcdf_output
  ...
  USE mesh_help_functions_module,  ONLY: PartitionList
...
CONTAINS
  ...
  SUBROUTINE initialise_PD_data_fields(        PD,   region_name)
    ...
    CALL PartitionList( PD%nx, par%i, par%n, PD%i1, PD%i2)
  ...
  SUBROUTINE initialise_init_data_fields_cart( init, region_name)
    ...
    ! Determine vertex domains
    CALL PartitionList( init%nx, par%i, par%n, init%i1, init%i2)
  ...
  SUBROUTINE initialise_init_data_fields_mesh( init, region_name, mesh)
    ...
    CALL allocate_shared_memory_int_2D( mesh%nV,      mesh%nC_mem, mesh%C,                mesh%wC               )
    CALL allocate_shared_memory_int_1D( mesh%nV,                   mesh%niTri,            mesh%wniTri           )
    CALL allocate_shared_memory_int_2D( mesh%nV,      mesh%nC_mem, mesh%iTri,             mesh%wiTri            )
