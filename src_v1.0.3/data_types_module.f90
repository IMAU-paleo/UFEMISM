MODULE data_types_module
  ...
  TYPE type_grid
    ...
    TYPE(type_mesh)                         :: mesh
    INTEGER,  DIMENSION(:,:  ), POINTER     :: map_square2grid
    INTEGER,  DIMENSION(:,:  ), POINTER     :: map_grid2square
    INTEGER :: wmap_square2grid, wmap_grid2square
    TYPE(type_remapping)                    :: map_square2mesh   ! Remapping arrays for mapping data between the unstructured
    TYPE(type_remapping)                    :: map_mesh2square   ! UFEMISM mesh and the semi-rectangular mesh of this grid.
