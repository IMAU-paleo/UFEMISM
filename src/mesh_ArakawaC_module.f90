...
#include <petsc/finclude/petscksp.h>
  ...
  SUBROUTINE make_Ac_mesh( mesh)
    ...
    CALL allocate_shared_dist_int_1D( mesh%nAc,      mesh%EMap,            mesh%wEMap           )
    CALL allocate_shared_dist_int_1D( mesh%nAc,      mesh%EStack1,         mesh%wEStack1        )
    CALL allocate_shared_dist_int_1D( mesh%nAc,      mesh%EStack2,         mesh%wEStack2        )
