...
% Plot results
line('parent',H.Ax1,'xdata',results.DIVA.time       /1e3,'ydata',results.DIVA.xGL_av        / 1e3,'linewidth',3,'color',c_with,'linestyle','-'); 
line('parent',H.Ax1,'xdata',results.hybrid.time     /1e3,'ydata',results.hybrid.xGL_av      / 1e3,'linewidth',3,'color',c_with,'linestyle','--'); 
line('parent',H.Ax1,'xdata',results.DIVA_sans.time  /1e3,'ydata',results.DIVA_sans.xGL_av   / 1e3,'linewidth',3,'color',c_sans,'linestyle','-');
line('parent',H.Ax1,'xdata',results.hybrid_sans.time/1e3,'ydata',results.hybrid_sans.xGL_av / 1e3,'linewidth',3,'color',c_sans,'linestyle','--');
...
for idi = 1: length( icedyns)
  ...
  results.(icedyns{idi}).SL.time  = time;
  results.(icedyns{idi}).SL.SL    = SL;
  results.(icedyns{idi}).SL.dSLdt = dSLdt;
...
% Plot results
line('parent',H.Ax2,'xdata',results.DIVA.SL.time       /1e3,'ydata',results.DIVA.SL.dSLdt        * 1e3,'linewidth',3,'color',c_with,'linestyle','-'); 
line('parent',H.Ax2,'xdata',results.hybrid.SL.time     /1e3,'ydata',results.hybrid.SL.dSLdt      * 1e3,'linewidth',3,'color',c_with,'linestyle','--'); 
line('parent',H.Ax2,'xdata',results.DIVA_sans.SL.time  /1e3,'ydata',results.DIVA_sans.SL.dSLdt   * 1e3,'linewidth',3,'color',c_sans,'linestyle','-');
line('parent',H.Ax2,'xdata',results.hybrid_sans.SL.time/1e3,'ydata',results.hybrid_sans.SL.dSLdt * 1e3,'linewidth',3,'color',c_sans,'linestyle','--');