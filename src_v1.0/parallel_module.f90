...
CONTAINS
  ...
  ! "crash" (print an error and stop) the program on all cores
  SUBROUTINE crash(subroutine_name, e1, e2, e3, e4, e5, e6, e7, e8, e9, e10)
  
    CHARACTER(LEN=*),           INTENT(IN) :: subroutine_name
    CHARACTER(LEN=*), OPTIONAL, INTENT(IN) :: e1
    CHARACTER(LEN=*), OPTIONAL, INTENT(IN) :: e2
    CHARACTER(LEN=*), OPTIONAL, INTENT(IN) :: e3
    CHARACTER(LEN=*), OPTIONAL, INTENT(IN) :: e4
    CHARACTER(LEN=*), OPTIONAL, INTENT(IN) :: e5
    CHARACTER(LEN=*), OPTIONAL, INTENT(IN) :: e6
    CHARACTER(LEN=*), OPTIONAL, INTENT(IN) :: e7
    CHARACTER(LEN=*), OPTIONAL, INTENT(IN) :: e8
    CHARACTER(LEN=*), OPTIONAL, INTENT(IN) :: e9
    CHARACTER(LEN=*), OPTIONAL, INTENT(IN) :: e10
    
    INTEGER :: ierr
    
    IF (par%master) WRITE(0,'(A)') 'ERROR - UFEMISM crashed in subroutine "', subroutine_name, '"'
    IF (par%master .AND. PRESENT(e1 )) WRITE(0,'(A)') '     ', e1
    IF (par%master .AND. PRESENT(e2 )) WRITE(0,'(A)') '     ', e2
    IF (par%master .AND. PRESENT(e3 )) WRITE(0,'(A)') '     ', e3
    IF (par%master .AND. PRESENT(e4 )) WRITE(0,'(A)') '     ', e4
    IF (par%master .AND. PRESENT(e5 )) WRITE(0,'(A)') '     ', e5
    IF (par%master .AND. PRESENT(e6 )) WRITE(0,'(A)') '     ', e6
    IF (par%master .AND. PRESENT(e7 )) WRITE(0,'(A)') '     ', e7
    IF (par%master .AND. PRESENT(e8 )) WRITE(0,'(A)') '     ', e8
    IF (par%master .AND. PRESENT(e9 )) WRITE(0,'(A)') '     ', e9
    IF (par%master .AND. PRESENT(e10)) WRITE(0,'(A)') '     ', e10
