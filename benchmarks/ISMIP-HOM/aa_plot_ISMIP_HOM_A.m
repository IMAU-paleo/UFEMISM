...
for a = 1:6
  ...
  % SIA/SSA
  filename = ['ISMIP_HOM_A_SIASSA_' Lstr '/help_fields_ANT_00001.nc'];
  ...
  % DIVA
  filename = ['ISMIP_HOM_A_DIVA_' Lstr '/help_fields_ANT_00001.nc'];
  mesh     = read_mesh_from_file( filename);
  trans.A  = calc_transect_matrix_a( mesh, trans.xt, trans.yt);
  time     = ncread( filename,'time');
  ti       = length( time);
  ...
  % BPA
  filename = ['ISMIP_HOM_A_BPA_' Lstr '/help_fields_ANT_00001.nc'];
  mesh     = read_mesh_from_file( filename);
  trans.A  = calc_transect_matrix_a( mesh, trans.xt, trans.yt);
  time     = ncread( filename,'time');
  ti       = length( time);
